...
-- ════════════════════════════════════════════════════════════════
--  Индексы для ультрабыстрого поиска (Оптимизация)
-- ════════════════════════════════════════════════════════════════
...
CREATE INDEX IF NOT EXISTS idx_channel_posts_brand ON channel_posts(brand_id);
CREATE INDEX IF NOT EXISTS idx_channel_posts_gender_cat ON channel_posts(gender, category);
CREATE INDEX IF NOT EXISTS idx_order_items_order ON order_items(order_id);
CREATE INDEX IF NOT EXISTS idx_ticket_messages_ticket ON ticket_messages(ticket_id);
CREATE INDEX IF NOT EXISTS idx_partner_ref_login ON partner_referrals(partner_login);
CREATE INDEX IF NOT EXISTS idx_stock_interest_post ON stock_interest(post_id);