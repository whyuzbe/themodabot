...
# а реальные категории в проекте — на русском (config.CATEGORIES). Из-за этого
# .get((gender, key), key) никогда не находил совпадение и всегда падал на
# запасной вариант — сырое русское название без эмодзи, в 4 разных местах:
# "📡 Каналы", "👁 Просмотр", создание и удаление разделов. Мужских сумок
# больше нет в CATEGORIES (убраны по просьбе заказчика), поэтому и здесь
# запись для них не нужна.
CATEGORY_LABELS_FLAT = {
    ("male", "Одежда"): "👔 Муж. одежда", ("male", "Обувь"): "👟 Муж. обувь",
    ("male", "Аксессуары"): "⌚️ Муж. аксессуары",
    ("female", "Одежда"): "👗 Жен. одежда", ("female", "Обувь"): "👠 Жен. обувь",
    ("female", "Аксессуары"): "💍 Жен. аксессуары", ("female", "Сумки"): "👜 Жен. сумки",
}
